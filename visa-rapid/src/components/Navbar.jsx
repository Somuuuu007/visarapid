      ...
      <div className="max-w-9xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden lg:flex items-center space-x-2">
            <a href="https://wa.me/9899982721" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 !text-white px-5 py-3 text-base font-bold transition-all duration-200 rounded-lg flex items-center gap-3">
          ...
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t border-gray-200">
              ...
              <div className="pt-4 pb-3 border-t border-gray-200 space-y-3">
                <a href="https://wa.me/9899982721" target="_blank" rel="noopener noreferrer" className="bg-green-500 hover:bg-green-600 !text-white px-6 py-4 text-lg font-bold transition-all duration-200 rounded-lg flex items-center gap-3 w-full justify-center">
